...
ALTER TABLE teams ADD COLUMN club_id VARCHAR(100) DEFAULT NULL AFTER country;
ALTER TABLE teams ADD CONSTRAINT fk_team_club FOREIGN KEY (club_id) REFERENCES clubs(id) ON DELETE SET NULL;
