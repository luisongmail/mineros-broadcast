# Especificación funcional — Interfaces de anotación estadística de béisbol
...
La interfaz de captura de lanzamiento debe registrar con precisión cada pitcheo y separar cuatro conceptos:
