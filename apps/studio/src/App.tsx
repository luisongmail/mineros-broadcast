...
import { GameEngine, type GameState } from '@playflow/game-engine';
import { BatterOverlay } from '@playflow/overlay-batter';
import { FinalScoreOverlay } from '@playflow/overlay-final-score';
import { InningTransitionOverlay } from '@playflow/overlay-inning-transition';
import { NextBattersOverlay } from '@playflow/overlay-next-batters';
import { Scorebug } from '@playflow/overlay-scorebug';
import { ScoreboardOverlay } from '@playflow/overlay-scoreboard';
import { SponsorBreakOverlay } from '@playflow/overlay-sponsor-break';
import { AnnouncementOverlay } from '@playflow/overlay-announcement';
import { SocialLowerThirdOverlay } from '@playflow/overlay-social-lower-third';
import { CountdownOverlay } from '@playflow/overlay-countdown';
import { SubstitutionOverlay } from '@playflow/overlay-substitution';
import { GameEventOverlay } from '@playflow/overlay-game-event';
import { LineupOverlay } from '@playflow/overlay-lineup';
import { PitcherOverlay } from '@playflow/overlay-pitcher';
            ...
            <div className="flex-1 flex flex-col overflow-hidden mt-2 border-t border-white/10">
              ...
              <div className="flex-1 overflow-y-auto">
                ...
                {rightTab === 'config' && (
                  <div className="p-4">
                    <GameConfigPanel
                      activeGameId={game.gameId || undefined}
